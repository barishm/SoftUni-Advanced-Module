package oop.t7_Reflection.harvestingFields;
...
public class Main {
	private static final Field[] RICH_SOIL_LAND_FIELD = RichSoilLand.class.getDeclaredFields();
	...
	private static void printFilteredFields(String modifier){
		Arrays.stream(RICH_SOIL_LAND_FIELD)
